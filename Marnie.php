    ...
    <section id="main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6">
                    <h1>Marnie (2014)</h1>
                    <p>A young girl is sent to the country for health reasons, where she meets an unlikely friend in the form of Marnie, a young girl with flowing blonde hair. As the friendship unravels Marnie has closer ties to the protagonist than we might expect.</p>
