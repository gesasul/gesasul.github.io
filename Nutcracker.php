            ...
            <div class="row">
                <div class="col-4">
                    <div class="showcase-box">
                        <img src="Nutracker.jpg">
                    </div>
                </div>
                <div class="col-6">
                    <h1>The Nutcracker (2018)</h1>
                    <p>On Christmas Eve, Clara realises that before dying, her mother left her with an inheritance to a magical world of fairies and toy soldiers that are alive. She holds the key to the fate of this world.</p>
