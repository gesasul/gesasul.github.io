            ...
            <div class="row">
                <div class="col-4">
                    <div class="showcase-box">
                        <img src="Annabelle.jpg">
                    </div>
                </div>
                <div class="col-6">
                    <h1>Anabelle Creation (2017)</h1>
                    <p>Samuel and Elle embed their daughter's spirit into a doll, only to realise it is a demon. Years later, they open their home to a nun and six orphan girls, one of whom finds the doll.</p>
