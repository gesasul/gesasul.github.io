            ...
            <div class="row">
                <div class="col-4">
                    <div class="showcase-box">
                        <img src="The Wind Rises.jpg">
                    </div>
                </div>
                <div class="col-6">
                    <h1>The Wind Rises (2013)</h1>
                    <p>A lifelong love of flight inspires Japanese aviation engineer Jiro Horikoshi (Hideaki Anno), whose storied career includes the creation of the A6M World War II fighter plane.</p>
