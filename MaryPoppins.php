            ...
            <div class="row">
                <div class="col-4">
                    <div class="showcase-box">
                        <img src="Mary Poppins.jpg">
                    </div>
                </div>
                <div class="col-6">
                    <h1>Marry Poppins (2018)</h1>
                    <p>Marry Poppins, a magical nanny, returns to the Banks and helps the family evade grave dangers by taking them all on various magical adventures.</p>
